...
class FleetRunnerTest(unittest.TestCase):
    ...
    def test_explicit_v1_migration_is_atomic_preserves_extensions_and_validates_terminals(self):
        ...
        with tempfile.TemporaryDirectory() as d:
            ...
            legacy={"schema_version":"1","id":"TASK-001","task_id":"TASK-001","slug":"TASK-001","status":"completed","runtime":"codex","ui":"headless","branch":branch,"worktree_path":".fleet-worktrees/TASK-001","started_at":"2026-09-09T12:00:00Z","updated_at":"2026-09-09T12:01:00Z","finished_at":"2026-09-09T12:02:00Z","result_path":"result.json","port":43000,"compose_project":"legacy-owned","compose_file":"docker-compose.yml","x-owner-note":{"keep":True}}
