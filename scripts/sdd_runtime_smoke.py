...
def task_008_approval_contract(runtime: str, ui: str, language: str) -> Dict[str, Any]:
    ...
    projection = {
        ...
        "public_ui_interface": {
            "argument": "--ui",
            "choices": ["auto", "cmux", "tmux", "headless"],
            "default": "auto",
            "auto_resolution_order": ["cmux-if-usable", "tmux-if-usable", "headless"],
        ...
        "operational_json_publication": {
            "preserve_unknown_fields": True,
            "validate_before_publication": True,
            "temporary_file": "same-directory",
            "replacement": "atomic",
        },
        "implementation_boundary": {
            "interactivity": "fleet-only",
            "command": "sdd-fleet",
