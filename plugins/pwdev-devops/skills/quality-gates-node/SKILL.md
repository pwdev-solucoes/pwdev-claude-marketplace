...
description: >
  ...
  TypeScript. Use quando o usuário pedir "quality gate Node", "quality gate backend",
  "ESLint", "tsc", testes, cobertura, complexidade, SAST, SCA, build ou baseline em Node.js.
