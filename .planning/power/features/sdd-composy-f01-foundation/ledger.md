...
Task 04: minor (resolved by Task 06): invalid schema fixtures now start from valid documents and mutate one constraint at a time, independently proving every advertised constraint.
