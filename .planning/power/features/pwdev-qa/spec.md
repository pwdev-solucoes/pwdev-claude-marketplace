...
Comandos verificados na skill local: playwright-cli --version; npx --no-install playwright-cli --version; playwright-cli -s=qa-report open; playwright-cli -s=qa-report snapshot; playwright-cli -s=qa-report screenshot --filename=report.png; playwright-cli -s=qa-report close.
